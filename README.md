...
A cross-platform cryptographic desktop toolkit built with [GPUI](https://www.gpui.rs/), supporting certificate analysis, algorithm exploration, and cryptographic operations.
